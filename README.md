...
| 役職 | 担当者 | 役割 |
|------|--------|------|
| **統括ディレクター** | 中越清登 | 全体統括・戦略策定・品質管理 |
| **特別アドバイザー** | 柴村直弥 | 技術助言・プロアスリート視点 |
| **テクニカルリード** | 北原寛也 | 技術責任・現場統括 |
| **データマネージャー** | 根本大洋 | データ管理・解析・レポート作成 |
| **フィールドオペレーター** | 瓜島大洋 | 現場測定・選手誘導 |
| **フィールドオペレーター** | 藤森颯 | 現場測定・選手誘導 |

**役割バランス表:**
- 中越: 全体統括（営業・戦略◎、データ○、現場△）
- 柴村: 技術助言（現場○、営業○、データ△）
- テクニカルリード: 技術責任（現場◎、データ△、営業△）
- データマネージャー: 解析（データ◎、現場△、営業△）
- オペレーター×2: 計測担当（現場◎、データ△）
