var vt=Object.defineProperty;var Be=e=>{throw TypeError(e)};var bt=(e,t,a)=>t in e?vt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var m=(e,t,a)=>bt(e,typeof t!="symbol"?t+"":t,a),Le=(e,t,a)=>t.has(e)||Be("Cannot "+a);var l=(e,t,a)=>(Le(e,t,"read from private field"),a?a.call(e):t.get(e)),x=(e,t,a)=>t.has(e)?Be("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),f=(e,t,a,s)=>(Le(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),g=(e,t,a)=>(Le(e,t,"access private method"),a);var _e=(e,t,a,s)=>({set _(i){f(e,t,i,a)},get _(){return l(e,t,s)}});var He=(e,t,a)=>(s,i)=>{let n=-1;return r(0);async function r(c){if(c<=n)throw new Error("next() called multiple times");n=c;let d,o=!1,p;if(e[c]?(p=e[c][0][0],s.req.routeIndex=c):p=c===e.length&&i||void 0,p)try{d=await p(s,()=>r(c+1))}catch(u){if(u instanceof Error&&t)s.error=u,d=await t(u,s),o=!0;else throw u}else s.finalized===!1&&a&&(d=await a(s));return d&&(s.finalized===!1||o)&&(s.res=d),s}},yt=Symbol(),jt=async(e,t=Object.create(null))=>{const{all:a=!1,dot:s=!1}=t,n=(e instanceof st?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?wt(e,{all:a,dot:s}):{}};async function wt(e,t){const a=await e.formData();return a?St(a,t):{}}function St(e,t){const a=Object.create(null);return e.forEach((s,i)=>{t.all||i.endsWith("[]")?Rt(a,i,s):a[i]=s}),t.dot&&Object.entries(a).forEach(([s,i])=>{s.includes(".")&&(Tt(a,s,i),delete a[s])}),a}var Rt=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Tt=(e,t,a)=>{let s=e;const i=t.split(".");i.forEach((n,r)=>{r===i.length-1?s[n]=a:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},Xe=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Et=e=>{const{groups:t,path:a}=kt(e),s=Xe(a);return At(s,t)},kt=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,s)=>{const i=`@${s}`;return t.push([i,a]),i}),{groups:t,path:e}},At=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[s]=t[a];for(let i=e.length-1;i>=0;i--)if(e[i].includes(s)){e[i]=e[i].replace(s,t[a][1]);break}}return e},Te={},Ot=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const s=`${e}#${t}`;return Te[s]||(a[2]?Te[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Te[s]=[e,a[1],!0]),Te[s]}return null},De=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},It=e=>De(e,decodeURI),Ze=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let s=a;for(;s<t.length;s++){const i=t.charCodeAt(s);if(i===37){const n=t.indexOf("?",s),r=t.slice(a,n===-1?void 0:n);return It(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(i===63)break}return t.slice(a,s)},Pt=e=>{const t=Ze(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ae=(e,t,...a)=>(a.length&&(t=ae(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let s="";return t.forEach(i=>{if(i!==""&&!/\:/.test(i))s+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){a.length===0&&s===""?a.push("/"):a.push(s);const n=i.replace("?","");s+="/"+n,a.push(s)}else s+="/"+i}),a.filter((i,n,r)=>r.indexOf(i)===n)},Fe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?De(e,at):e):e,tt=(e,t,a)=>{let s;if(!a&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const c=e.charCodeAt(r+t.length+1);if(c===61){const d=r+t.length+2,o=e.indexOf("&",d);return Fe(e.slice(d,o===-1?void 0:o))}else if(c==38||isNaN(c))return"";r=e.indexOf(`&${t}`,r+1)}if(s=/[%+]/.test(e),!s)return}const i={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const r=e.indexOf("&",n+1);let c=e.indexOf("=",n);c>r&&r!==-1&&(c=-1);let d=e.slice(n+1,c===-1?r===-1?void 0:r:c);if(s&&(d=Fe(d)),n=r,d==="")continue;let o;c===-1?o="":(o=e.slice(c+1,r===-1?void 0:r),s&&(o=Fe(o))),a?(i[d]&&Array.isArray(i[d])||(i[d]=[]),i[d].push(o)):i[d]??(i[d]=o)}return t?i[t]:i},Ct=tt,Lt=(e,t)=>tt(e,t,!0),at=decodeURIComponent,$e=e=>De(e,at),ne,k,V,it,nt,Ne,H,We,st=(We=class{constructor(e,t="/",a=[[]]){x(this,V);m(this,"raw");x(this,ne);x(this,k);m(this,"routeIndex",0);m(this,"path");m(this,"bodyCache",{});x(this,H,e=>{const{bodyCache:t,raw:a}=this,s=t[e];if(s)return s;const i=Object.keys(t)[0];return i?t[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,f(this,k,a),f(this,ne,{})}param(e){return e?g(this,V,it).call(this,e):g(this,V,nt).call(this)}query(e){return Ct(this.url,e)}queries(e){return Lt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,s)=>{t[s]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await jt(this,e))}json(){return l(this,H).call(this,"text").then(e=>JSON.parse(e))}text(){return l(this,H).call(this,"text")}arrayBuffer(){return l(this,H).call(this,"arrayBuffer")}blob(){return l(this,H).call(this,"blob")}formData(){return l(this,H).call(this,"formData")}addValidatedData(e,t){l(this,ne)[e]=t}valid(e){return l(this,ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[yt](){return l(this,k)}get matchedRoutes(){return l(this,k)[0].map(([[,e]])=>e)}get routePath(){return l(this,k)[0].map(([[,e]])=>e)[this.routeIndex].path}},ne=new WeakMap,k=new WeakMap,V=new WeakSet,it=function(e){const t=l(this,k)[0][this.routeIndex][1][e],a=g(this,V,Ne).call(this,t);return a&&/\%/.test(a)?$e(a):a},nt=function(){const e={},t=Object.keys(l(this,k)[0][this.routeIndex][1]);for(const a of t){const s=g(this,V,Ne).call(this,l(this,k)[0][this.routeIndex][1][a]);s!==void 0&&(e[a]=/\%/.test(s)?$e(s):s)}return e},Ne=function(e){return l(this,k)[1]?l(this,k)[1][e]:e},H=new WeakMap,We),Ft={Stringify:1},rt=async(e,t,a,s,i)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(i?i[0]+=e:i=[e],Promise.all(n.map(c=>c({phase:t,buffer:i,context:s}))).then(c=>Promise.all(c.filter(Boolean).map(d=>rt(d,t,!1,s,i))).then(()=>i[0]))):Promise.resolve(e)},Mt="text/plain; charset=UTF-8",Me=(e,t)=>({"Content-Type":e,...t}),xe,ge,F,re,M,E,ve,le,oe,K,be,ye,$,se,Je,Nt=(Je=class{constructor(e,t){x(this,$);x(this,xe);x(this,ge);m(this,"env",{});x(this,F);m(this,"finalized",!1);m(this,"error");x(this,re);x(this,M);x(this,E);x(this,ve);x(this,le);x(this,oe);x(this,K);x(this,be);x(this,ye);m(this,"render",(...e)=>(l(this,le)??f(this,le,t=>this.html(t)),l(this,le).call(this,...e)));m(this,"setLayout",e=>f(this,ve,e));m(this,"getLayout",()=>l(this,ve));m(this,"setRenderer",e=>{f(this,le,e)});m(this,"header",(e,t,a)=>{this.finalized&&f(this,E,new Response(l(this,E).body,l(this,E)));const s=l(this,E)?l(this,E).headers:l(this,K)??f(this,K,new Headers);t===void 0?s.delete(e):a!=null&&a.append?s.append(e,t):s.set(e,t)});m(this,"status",e=>{f(this,re,e)});m(this,"set",(e,t)=>{l(this,F)??f(this,F,new Map),l(this,F).set(e,t)});m(this,"get",e=>l(this,F)?l(this,F).get(e):void 0);m(this,"newResponse",(...e)=>g(this,$,se).call(this,...e));m(this,"body",(e,t,a)=>g(this,$,se).call(this,e,t,a));m(this,"text",(e,t,a)=>!l(this,K)&&!l(this,re)&&!t&&!a&&!this.finalized?new Response(e):g(this,$,se).call(this,e,t,Me(Mt,a)));m(this,"json",(e,t,a)=>g(this,$,se).call(this,JSON.stringify(e),t,Me("application/json",a)));m(this,"html",(e,t,a)=>{const s=i=>g(this,$,se).call(this,i,t,Me("text/html; charset=UTF-8",a));return typeof e=="object"?rt(e,Ft.Stringify,!1,{}).then(s):s(e)});m(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});m(this,"notFound",()=>(l(this,oe)??f(this,oe,()=>new Response),l(this,oe).call(this,this)));f(this,xe,e),t&&(f(this,M,t.executionCtx),this.env=t.env,f(this,oe,t.notFoundHandler),f(this,ye,t.path),f(this,be,t.matchResult))}get req(){return l(this,ge)??f(this,ge,new st(l(this,xe),l(this,ye),l(this,be))),l(this,ge)}get event(){if(l(this,M)&&"respondWith"in l(this,M))return l(this,M);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,M))return l(this,M);throw Error("This context has no ExecutionContext")}get res(){return l(this,E)||f(this,E,new Response(null,{headers:l(this,K)??f(this,K,new Headers)}))}set res(e){if(l(this,E)&&e){e=new Response(e.body,e);for(const[t,a]of l(this,E).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=l(this,E).headers.getSetCookie();e.headers.delete("set-cookie");for(const i of s)e.headers.append("set-cookie",i)}else e.headers.set(t,a)}f(this,E,e),this.finalized=!0}get var(){return l(this,F)?Object.fromEntries(l(this,F)):{}}},xe=new WeakMap,ge=new WeakMap,F=new WeakMap,re=new WeakMap,M=new WeakMap,E=new WeakMap,ve=new WeakMap,le=new WeakMap,oe=new WeakMap,K=new WeakMap,be=new WeakMap,ye=new WeakMap,$=new WeakSet,se=function(e,t,a){const s=l(this,E)?new Headers(l(this,E).headers):l(this,K)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,c]of n)r.toLowerCase()==="set-cookie"?s.append(r,c):s.set(r,c)}if(a)for(const[n,r]of Object.entries(a))if(typeof r=="string")s.set(n,r);else{s.delete(n);for(const c of r)s.append(n,c)}const i=typeof t=="number"?t:(t==null?void 0:t.status)??l(this,re);return new Response(e,{status:i,headers:s})},Je),j="ALL",Dt="all",Vt=["get","post","put","delete","options","patch"],lt="Can not add a route since the matcher is already built.",ot=class extends Error{},Bt="__COMPOSED_HANDLER",_t=e=>e.text("404 Not Found",404),qe=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},A,w,dt,O,J,Ee,ke,de,Ht=(de=class{constructor(t={}){x(this,w);m(this,"get");m(this,"post");m(this,"put");m(this,"delete");m(this,"options");m(this,"patch");m(this,"all");m(this,"on");m(this,"use");m(this,"router");m(this,"getPath");m(this,"_basePath","/");x(this,A,"/");m(this,"routes",[]);x(this,O,_t);m(this,"errorHandler",qe);m(this,"onError",t=>(this.errorHandler=t,this));m(this,"notFound",t=>(f(this,O,t),this));m(this,"fetch",(t,...a)=>g(this,w,ke).call(this,t,a[1],a[0],t.method));m(this,"request",(t,a,s,i)=>t instanceof Request?this.fetch(a?new Request(t,a):t,s,i):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ae("/",t)}`,a),s,i)));m(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(g(this,w,ke).call(this,t.request,t,void 0,t.request.method))})});[...Vt,Dt].forEach(n=>{this[n]=(r,...c)=>(typeof r=="string"?f(this,A,r):g(this,w,J).call(this,n,l(this,A),r),c.forEach(d=>{g(this,w,J).call(this,n,l(this,A),d)}),this)}),this.on=(n,r,...c)=>{for(const d of[r].flat()){f(this,A,d);for(const o of[n].flat())c.map(p=>{g(this,w,J).call(this,o.toUpperCase(),l(this,A),p)})}return this},this.use=(n,...r)=>(typeof n=="string"?f(this,A,n):(f(this,A,"*"),r.unshift(n)),r.forEach(c=>{g(this,w,J).call(this,j,l(this,A),c)}),this);const{strict:s,...i}=t;Object.assign(this,i),this.getPath=s??!0?t.getPath??Ze:Pt}route(t,a){const s=this.basePath(t);return a.routes.map(i=>{var r;let n;a.errorHandler===qe?n=i.handler:(n=async(c,d)=>(await He([],a.errorHandler)(c,()=>i.handler(c,d))).res,n[Bt]=i.handler),g(r=s,w,J).call(r,i.method,i.path,n)}),this}basePath(t){const a=g(this,w,dt).call(this);return a._basePath=ae(this._basePath,t),a}mount(t,a,s){let i,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?i=d=>d:i=s.replaceRequest));const r=n?d=>{const o=n(d);return Array.isArray(o)?o:[o]}:d=>{let o;try{o=d.executionCtx}catch{}return[d.env,o]};i||(i=(()=>{const d=ae(this._basePath,t),o=d==="/"?0:d.length;return p=>{const u=new URL(p.url);return u.pathname=u.pathname.slice(o)||"/",new Request(u,p)}})());const c=async(d,o)=>{const p=await a(i(d.req.raw),...r(d));if(p)return p;await o()};return g(this,w,J).call(this,j,ae(t,"*"),c),this}},A=new WeakMap,w=new WeakSet,dt=function(){const t=new de({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,f(t,O,l(this,O)),t.routes=this.routes,t},O=new WeakMap,J=function(t,a,s){t=t.toUpperCase(),a=ae(this._basePath,a);const i={basePath:this._basePath,path:a,method:t,handler:s};this.router.add(t,a,[s,i]),this.routes.push(i)},Ee=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ke=function(t,a,s,i){if(i==="HEAD")return(async()=>new Response(null,await g(this,w,ke).call(this,t,a,s,"GET")))();const n=this.getPath(t,{env:s}),r=this.router.match(i,n),c=new Nt(t,{path:n,matchResult:r,env:s,executionCtx:a,notFoundHandler:l(this,O)});if(r[0].length===1){let o;try{o=r[0][0][0][0](c,async()=>{c.res=await l(this,O).call(this,c)})}catch(p){return g(this,w,Ee).call(this,p,c)}return o instanceof Promise?o.then(p=>p||(c.finalized?c.res:l(this,O).call(this,c))).catch(p=>g(this,w,Ee).call(this,p,c)):o??l(this,O).call(this,c)}const d=He(r[0],this.errorHandler,l(this,O));return(async()=>{try{const o=await d(c);if(!o.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return o.res}catch(o){return g(this,w,Ee).call(this,o,c)}})()},de),ct=[];function $t(e,t){const a=this.buildAllMatchers(),s=((i,n)=>{const r=a[i]||a[j],c=r[2][n];if(c)return c;const d=n.match(r[0]);if(!d)return[[],ct];const o=d.indexOf("",1);return[r[1][o],d]});return this.match=s,s(e,t)}var Oe="[^/]+",me=".*",he="(?:|/.*)",ie=Symbol(),qt=new Set(".\\+*[^]$()");function zt(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===me||e===he?1:t===me||t===he?-1:e===Oe?1:t===Oe?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Y,Q,I,ee,Ut=(ee=class{constructor(){x(this,Y);x(this,Q);x(this,I,Object.create(null))}insert(t,a,s,i,n){if(t.length===0){if(l(this,Y)!==void 0)throw ie;if(n)return;f(this,Y,a);return}const[r,...c]=t,d=r==="*"?c.length===0?["","",me]:["","",Oe]:r==="/*"?["","",he]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let o;if(d){const p=d[1];let u=d[2]||Oe;if(p&&d[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ie;if(o=l(this,I)[u],!o){if(Object.keys(l(this,I)).some(h=>h!==me&&h!==he))throw ie;if(n)return;o=l(this,I)[u]=new ee,p!==""&&f(o,Q,i.varIndex++)}!n&&p!==""&&s.push([p,l(o,Q)])}else if(o=l(this,I)[r],!o){if(Object.keys(l(this,I)).some(p=>p.length>1&&p!==me&&p!==he))throw ie;if(n)return;o=l(this,I)[r]=new ee}o.insert(c,a,s,i,n)}buildRegExpStr(){const a=Object.keys(l(this,I)).sort(zt).map(s=>{const i=l(this,I)[s];return(typeof l(i,Q)=="number"?`(${s})@${l(i,Q)}`:qt.has(s)?`\\${s}`:s)+i.buildRegExpStr()});return typeof l(this,Y)=="number"&&a.unshift(`#${l(this,Y)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Y=new WeakMap,Q=new WeakMap,I=new WeakMap,ee),Ie,je,Ge,Wt=(Ge=class{constructor(){x(this,Ie,{varIndex:0});x(this,je,new Ut)}insert(e,t,a){const s=[],i=[];for(let r=0;;){let c=!1;if(e=e.replace(/\{[^}]+\}/g,d=>{const o=`@\\${r}`;return i[r]=[o,d],r++,c=!0,o}),!c)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=i.length-1;r>=0;r--){const[c]=i[r];for(let d=n.length-1;d>=0;d--)if(n[d].indexOf(c)!==-1){n[d]=n[d].replace(c,i[r][1]);break}}return l(this,je).insert(n,t,s,l(this,Ie),a),s}buildRegExp(){let e=l(this,je).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,r)=>n!==void 0?(a[++t]=Number(n),"$()"):(r!==void 0&&(s[Number(r)]=++t),"")),[new RegExp(`^${e}`),a,s]}},Ie=new WeakMap,je=new WeakMap,Ge),Jt=[/^$/,[],Object.create(null)],Ae=Object.create(null);function pt(e){return Ae[e]??(Ae[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Gt(){Ae=Object.create(null)}function Kt(e){var o;const t=new Wt,a=[];if(e.length===0)return Jt;const s=e.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,u],[h,b])=>p?1:h?-1:u.length-b.length),i=Object.create(null);for(let p=0,u=-1,h=s.length;p<h;p++){const[b,y,P]=s[p];b?i[y]=[P.map(([S])=>[S,Object.create(null)]),ct]:u++;let v;try{v=t.insert(y,u,b)}catch(S){throw S===ie?new ot(y):S}b||(a[u]=P.map(([S,B])=>{const Se=Object.create(null);for(B-=1;B>=0;B--){const[Re,C]=v[B];Se[Re]=C}return[S,Se]}))}const[n,r,c]=t.buildRegExp();for(let p=0,u=a.length;p<u;p++)for(let h=0,b=a[p].length;h<b;h++){const y=(o=a[p][h])==null?void 0:o[1];if(!y)continue;const P=Object.keys(y);for(let v=0,S=P.length;v<S;v++)y[P[v]]=c[y[P[v]]]}const d=[];for(const p in r)d[p]=a[r[p]];return[n,d,i]}function te(e,t){if(e){for(const a of Object.keys(e).sort((s,i)=>i.length-s.length))if(pt(a).test(t))return[...e[a]]}}var q,z,Pe,ut,Ke,Yt=(Ke=class{constructor(){x(this,Pe);m(this,"name","RegExpRouter");x(this,q);x(this,z);m(this,"match",$t);f(this,q,{[j]:Object.create(null)}),f(this,z,{[j]:Object.create(null)})}add(e,t,a){var c;const s=l(this,q),i=l(this,z);if(!s||!i)throw new Error(lt);s[e]||[s,i].forEach(d=>{d[e]=Object.create(null),Object.keys(d[j]).forEach(o=>{d[e][o]=[...d[j][o]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const d=pt(t);e===j?Object.keys(s).forEach(o=>{var p;(p=s[o])[t]||(p[t]=te(s[o],t)||te(s[j],t)||[])}):(c=s[e])[t]||(c[t]=te(s[e],t)||te(s[j],t)||[]),Object.keys(s).forEach(o=>{(e===j||e===o)&&Object.keys(s[o]).forEach(p=>{d.test(p)&&s[o][p].push([a,n])})}),Object.keys(i).forEach(o=>{(e===j||e===o)&&Object.keys(i[o]).forEach(p=>d.test(p)&&i[o][p].push([a,n]))});return}const r=et(t)||[t];for(let d=0,o=r.length;d<o;d++){const p=r[d];Object.keys(i).forEach(u=>{var h;(e===j||e===u)&&((h=i[u])[p]||(h[p]=[...te(s[u],p)||te(s[j],p)||[]]),i[u][p].push([a,n-o+d+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(l(this,z)).concat(Object.keys(l(this,q))).forEach(t=>{e[t]||(e[t]=g(this,Pe,ut).call(this,t))}),f(this,q,f(this,z,void 0)),Gt(),e}},q=new WeakMap,z=new WeakMap,Pe=new WeakSet,ut=function(e){const t=[];let a=e===j;return[l(this,q),l(this,z)].forEach(s=>{const i=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];i.length!==0?(a||(a=!0),t.push(...i)):e!==j&&t.push(...Object.keys(s[j]).map(n=>[n,s[j][n]]))}),a?Kt(t):null},Ke),U,N,Ye,Qt=(Ye=class{constructor(e){m(this,"name","SmartRouter");x(this,U,[]);x(this,N,[]);f(this,U,e.routers)}add(e,t,a){if(!l(this,N))throw new Error(lt);l(this,N).push([e,t,a])}match(e,t){if(!l(this,N))throw new Error("Fatal error");const a=l(this,U),s=l(this,N),i=a.length;let n=0,r;for(;n<i;n++){const c=a[n];try{for(let d=0,o=s.length;d<o;d++)c.add(...s[d]);r=c.match(e,t)}catch(d){if(d instanceof ot)continue;throw d}this.match=c.match.bind(c),f(this,U,[c]),f(this,N,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(l(this,N)||l(this,U).length!==1)throw new Error("No active router has been determined yet.");return l(this,U)[0]}},U=new WeakMap,N=new WeakMap,Ye),fe=Object.create(null),W,T,X,ce,R,D,G,pe,Xt=(pe=class{constructor(t,a,s){x(this,D);x(this,W);x(this,T);x(this,X);x(this,ce,0);x(this,R,fe);if(f(this,T,s||Object.create(null)),f(this,W,[]),t&&a){const i=Object.create(null);i[t]={handler:a,possibleKeys:[],score:0},f(this,W,[i])}f(this,X,[])}insert(t,a,s){f(this,ce,++_e(this,ce)._);let i=this;const n=Et(a),r=[];for(let c=0,d=n.length;c<d;c++){const o=n[c],p=n[c+1],u=Ot(o,p),h=Array.isArray(u)?u[0]:o;if(h in l(i,T)){i=l(i,T)[h],u&&r.push(u[1]);continue}l(i,T)[h]=new pe,u&&(l(i,X).push(u),r.push(u[1])),i=l(i,T)[h]}return l(i,W).push({[t]:{handler:s,possibleKeys:r.filter((c,d,o)=>o.indexOf(c)===d),score:l(this,ce)}}),i}search(t,a){var d;const s=[];f(this,R,fe);let n=[this];const r=Xe(a),c=[];for(let o=0,p=r.length;o<p;o++){const u=r[o],h=o===p-1,b=[];for(let y=0,P=n.length;y<P;y++){const v=n[y],S=l(v,T)[u];S&&(f(S,R,l(v,R)),h?(l(S,T)["*"]&&s.push(...g(this,D,G).call(this,l(S,T)["*"],t,l(v,R))),s.push(...g(this,D,G).call(this,S,t,l(v,R)))):b.push(S));for(let B=0,Se=l(v,X).length;B<Se;B++){const Re=l(v,X)[B],C=l(v,R)===fe?{}:{...l(v,R)};if(Re==="*"){const _=l(v,T)["*"];_&&(s.push(...g(this,D,G).call(this,_,t,l(v,R))),f(_,R,C),b.push(_));continue}const[xt,Ve,ue]=Re;if(!u&&!(ue instanceof RegExp))continue;const L=l(v,T)[xt],gt=r.slice(o).join("/");if(ue instanceof RegExp){const _=ue.exec(gt);if(_){if(C[Ve]=_[0],s.push(...g(this,D,G).call(this,L,t,l(v,R),C)),Object.keys(l(L,T)).length){f(L,R,C);const Ce=((d=_[0].match(/\//))==null?void 0:d.length)??0;(c[Ce]||(c[Ce]=[])).push(L)}continue}}(ue===!0||ue.test(u))&&(C[Ve]=u,h?(s.push(...g(this,D,G).call(this,L,t,C,l(v,R))),l(L,T)["*"]&&s.push(...g(this,D,G).call(this,l(L,T)["*"],t,C,l(v,R)))):(f(L,R,C),b.push(L)))}}n=b.concat(c.shift()??[])}return s.length>1&&s.sort((o,p)=>o.score-p.score),[s.map(({handler:o,params:p})=>[o,p])]}},W=new WeakMap,T=new WeakMap,X=new WeakMap,ce=new WeakMap,R=new WeakMap,D=new WeakSet,G=function(t,a,s,i){const n=[];for(let r=0,c=l(t,W).length;r<c;r++){const d=l(t,W)[r],o=d[a]||d[j],p={};if(o!==void 0&&(o.params=Object.create(null),n.push(o),s!==fe||i&&i!==fe))for(let u=0,h=o.possibleKeys.length;u<h;u++){const b=o.possibleKeys[u],y=p[o.score];o.params[b]=i!=null&&i[b]&&!y?i[b]:s[b]??(i==null?void 0:i[b]),p[o.score]=!0}}return n},pe),Z,Qe,Zt=(Qe=class{constructor(){m(this,"name","TrieRouter");x(this,Z);f(this,Z,new Xt)}add(e,t,a){const s=et(t);if(s){for(let i=0,n=s.length;i<n;i++)l(this,Z).insert(e,s[i],a);return}l(this,Z).insert(e,t,a)}match(e,t){return l(this,Z).search(e,t)}},Z=new WeakMap,Qe),ft=class extends Ht{constructor(e={}){super(e),this.router=e.router??new Qt({routers:[new Yt,new Zt]})}},ea=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(n=>typeof n=="string"?n==="*"?()=>n:r=>n===r?r:null:typeof n=="function"?n:r=>n.includes(r)?r:null)(a.origin),i=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(a.allowMethods);return async function(r,c){var p;function d(u,h){r.res.headers.set(u,h)}const o=await s(r.req.header("origin")||"",r);if(o&&d("Access-Control-Allow-Origin",o),a.credentials&&d("Access-Control-Allow-Credentials","true"),(p=a.exposeHeaders)!=null&&p.length&&d("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),r.req.method==="OPTIONS"){a.origin!=="*"&&d("Vary","Origin"),a.maxAge!=null&&d("Access-Control-Max-Age",a.maxAge.toString());const u=await i(r.req.header("origin")||"",r);u.length&&d("Access-Control-Allow-Methods",u.join(","));let h=a.allowHeaders;if(!(h!=null&&h.length)){const b=r.req.header("Access-Control-Request-Headers");b&&(h=b.split(/\s*,\s*/))}return h!=null&&h.length&&(d("Access-Control-Allow-Headers",h.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await c(),a.origin!=="*"&&r.header("Vary","Origin",{append:!0})}},ta=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,ze=(e,t=sa)=>{const a=/\.([a-zA-Z0-9]+?)$/,s=e.match(a);if(!s)return;let i=t[s[1]];return i&&i.startsWith("text")&&(i+="; charset=utf-8"),i},aa={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},sa=aa,ia=(...e)=>{let t=e.filter(i=>i!=="").join("/");t=t.replace(new RegExp("(?<=\\/)\\/+","g"),"");const a=t.split("/"),s=[];for(const i of a)i===".."&&s.length>0&&s.at(-1)!==".."?s.pop():i!=="."&&s.push(i);return s.join("/")||"."},mt={br:".br",zstd:".zst",gzip:".gz"},na=Object.keys(mt),ra="index.html",la=e=>{const t=e.root??"./",a=e.path,s=e.join??ia;return async(i,n)=>{var p,u,h,b;if(i.finalized)return n();let r;if(e.path)r=e.path;else try{if(r=decodeURIComponent(i.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(r))throw new Error}catch{return await((p=e.onNotFound)==null?void 0:p.call(e,i.req.path,i)),n()}let c=s(t,!a&&e.rewriteRequestPath?e.rewriteRequestPath(r):r);e.isDir&&await e.isDir(c)&&(c=s(c,ra));const d=e.getContent;let o=await d(c,i);if(o instanceof Response)return i.newResponse(o.body,o);if(o){const y=e.mimes&&ze(c,e.mimes)||ze(c);if(i.header("Content-Type",y||"application/octet-stream"),e.precompressed&&(!y||ta.test(y))){const P=new Set((u=i.req.header("Accept-Encoding"))==null?void 0:u.split(",").map(v=>v.trim()));for(const v of na){if(!P.has(v))continue;const S=await d(c+mt[v],i);if(S){o=S,i.header("Content-Encoding",v),i.header("Vary","Accept-Encoding",{append:!0});break}}}return await((h=e.onFound)==null?void 0:h.call(e,c,i)),i.body(o)}await((b=e.onNotFound)==null?void 0:b.call(e,c,i)),await n()}},oa=async(e,t)=>{let a;t&&t.manifest?typeof t.manifest=="string"?a=JSON.parse(t.manifest):a=t.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?a=JSON.parse(__STATIC_CONTENT_MANIFEST):a=__STATIC_CONTENT_MANIFEST;let s;t&&t.namespace?s=t.namespace:s=__STATIC_CONTENT;const i=a[e]||e;if(!i)return null;const n=await s.get(i,{type:"stream"});return n||null},da=e=>async function(a,s){return la({...e,getContent:async n=>oa(n,{manifest:e.manifest,namespace:e.namespace?e.namespace:a.env?a.env.__STATIC_CONTENT:void 0})})(a,s)},ca=e=>da(e);const we=new ft;we.use("/api/*",ea());we.use("/static/*",ca({root:"./public"}));we.post("/api/contact",async e=>{var t;try{const a=await e.req.json(),{name:s,email:i,organization:n,phone:r,message:c,type:d,language:o}=a;if(!s||!i||!c)return e.json({success:!1,error:"Required fields are missing"},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))return e.json({success:!1,error:"Invalid email format"},400);console.log("Contact form submission:",{name:s,email:i,organization:n,phone:r,message:c,type:d,language:o});const u=o==="ja"?`【VALORISE】新規お問い合わせ - ${s}様`:`[VALORISE] New Inquiry - ${s}`,h=`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<body class="smooth-scroll">
  ...
  `));const Ue=new ft,pa=Object.assign({"/src/index.tsx":we});let ht=!1;for(const[,e]of Object.entries(pa))e&&(Ue.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Ue.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ht=!0);if(!ht)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{Ue as default};
