var va=Object.defineProperty;var Bt=t=>{throw TypeError(t)};var ba=(t,a,e)=>a in t?va(t,a,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[a]=e;var u=(t,a,e)=>ba(t,typeof a!="symbol"?a+"":a,e),Lt=(t,a,e)=>a.has(t)||Bt("Cannot "+e);var l=(t,a,e)=>(Lt(t,a,"read from private field"),e?e.call(t):a.get(t)),x=(t,a,e)=>a.has(t)?Bt("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,e),m=(t,a,e,s)=>(Lt(t,a,"write to private field"),s?s.call(t,e):a.set(t,e),e),g=(t,a,e)=>(Lt(t,a,"access private method"),e);var Ht=(t,a,e,s)=>({set _(i){m(t,a,i,e)},get _(){return l(t,a,s)}});var _t=(t,a,e)=>(s,i)=>{let n=-1;return r(0);async function r(c){if(c<=n)throw new Error("next() called multiple times");n=c;let o,d=!1,p;if(t[c]?(p=t[c][0][0],s.req.routeIndex=c):p=c===t.length&&i||void 0,p)try{o=await p(s,()=>r(c+1))}catch(f){if(f instanceof Error&&a)s.error=f,o=await a(f,s),d=!0;else throw f}else s.finalized===!1&&e&&(o=await e(s));return o&&(s.finalized===!1||d)&&(s.res=o),s}},ya=Symbol(),ja=async(t,a=Object.create(null))=>{const{all:e=!1,dot:s=!1}=a,n=(t instanceof sa?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?wa(t,{all:e,dot:s}):{}};async function wa(t,a){const e=await t.formData();return e?Sa(e,a):{}}function Sa(t,a){const e=Object.create(null);return t.forEach((s,i)=>{a.all||i.endsWith("[]")?Ra(e,i,s):e[i]=s}),a.dot&&Object.entries(e).forEach(([s,i])=>{s.includes(".")&&(ka(e,s,i),delete e[s])}),e}var Ra=(t,a,e)=>{t[a]!==void 0?Array.isArray(t[a])?t[a].push(e):t[a]=[t[a],e]:a.endsWith("[]")?t[a]=[e]:t[a]=e},ka=(t,a,e)=>{let s=t;const i=a.split(".");i.forEach((n,r)=>{r===i.length-1?s[n]=e:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},Xt=t=>{const a=t.split("/");return a[0]===""&&a.shift(),a},Ta=t=>{const{groups:a,path:e}=Ea(t),s=Xt(e);return Aa(s,a)},Ea=t=>{const a=[];return t=t.replace(/\{[^}]+\}/g,(e,s)=>{const i=`@${s}`;return a.push([i,e]),i}),{groups:a,path:t}},Aa=(t,a)=>{for(let e=a.length-1;e>=0;e--){const[s]=a[e];for(let i=t.length-1;i>=0;i--)if(t[i].includes(s)){t[i]=t[i].replace(s,a[e][1]);break}}return t},kt={},Oa=(t,a)=>{if(t==="*")return"*";const e=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const s=`${t}#${a}`;return kt[s]||(e[2]?kt[s]=a&&a[0]!==":"&&a[0]!=="*"?[s,e[1],new RegExp(`^${e[2]}(?=/${a})`)]:[t,e[1],new RegExp(`^${e[2]}$`)]:kt[s]=[t,e[1],!0]),kt[s]}return null},Nt=(t,a)=>{try{return a(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return a(e)}catch{return e}})}},Ca=t=>Nt(t,decodeURI),Zt=t=>{const a=t.url,e=a.indexOf("/",a.indexOf(":")+4);let s=e;for(;s<a.length;s++){const i=a.charCodeAt(s);if(i===37){const n=a.indexOf("?",s),r=a.slice(e,n===-1?void 0:n);return Ca(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(i===63)break}return a.slice(e,s)},Ia=t=>{const a=Zt(t);return a.length>1&&a.at(-1)==="/"?a.slice(0,-1):a},et=(t,a,...e)=>(e.length&&(a=et(a,...e)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${a==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(a==null?void 0:a[0])==="/"?a.slice(1):a}`}`),ta=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const a=t.split("/"),e=[];let s="";return a.forEach(i=>{if(i!==""&&!/\:/.test(i))s+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&s===""?e.push("/"):e.push(s);const n=i.replace("?","");s+="/"+n,e.push(s)}else s+="/"+i}),e.filter((i,n,r)=>r.indexOf(i)===n)},Ft=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Nt(t,ea):t):t,aa=(t,a,e)=>{let s;if(!e&&a&&!/[%+]/.test(a)){let r=t.indexOf("?",8);if(r===-1)return;for(t.startsWith(a,r+1)||(r=t.indexOf(`&${a}`,r+1));r!==-1;){const c=t.charCodeAt(r+a.length+1);if(c===61){const o=r+a.length+2,d=t.indexOf("&",o);return Ft(t.slice(o,d===-1?void 0:d))}else if(c==38||isNaN(c))return"";r=t.indexOf(`&${a}`,r+1)}if(s=/[%+]/.test(t),!s)return}const i={};s??(s=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const r=t.indexOf("&",n+1);let c=t.indexOf("=",n);c>r&&r!==-1&&(c=-1);let o=t.slice(n+1,c===-1?r===-1?void 0:r:c);if(s&&(o=Ft(o)),n=r,o==="")continue;let d;c===-1?d="":(d=t.slice(c+1,r===-1?void 0:r),s&&(d=Ft(d))),e?(i[o]&&Array.isArray(i[o])||(i[o]=[]),i[o].push(d)):i[o]??(i[o]=d)}return a?i[a]:i},Pa=aa,La=(t,a)=>aa(t,a,!0),ea=decodeURIComponent,$t=t=>Nt(t,ea),nt,E,V,ia,na,Dt,_,Jt,sa=(Jt=class{constructor(t,a="/",e=[[]]){x(this,V);u(this,"raw");x(this,nt);x(this,E);u(this,"routeIndex",0);u(this,"path");u(this,"bodyCache",{});x(this,_,t=>{const{bodyCache:a,raw:e}=this,s=a[t];if(s)return s;const i=Object.keys(a)[0];return i?a[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):a[t]=e[t]()});this.raw=t,this.path=a,m(this,E,e),m(this,nt,{})}param(t){return t?g(this,V,ia).call(this,t):g(this,V,na).call(this)}query(t){return Pa(this.url,t)}queries(t){return La(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const a={};return this.raw.headers.forEach((e,s)=>{a[s]=e}),a}async parseBody(t){var a;return(a=this.bodyCache).parsedBody??(a.parsedBody=await ja(this,t))}json(){return l(this,_).call(this,"text").then(t=>JSON.parse(t))}text(){return l(this,_).call(this,"text")}arrayBuffer(){return l(this,_).call(this,"arrayBuffer")}blob(){return l(this,_).call(this,"blob")}formData(){return l(this,_).call(this,"formData")}addValidatedData(t,a){l(this,nt)[t]=a}valid(t){return l(this,nt)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ya](){return l(this,E)}get matchedRoutes(){return l(this,E)[0].map(([[,t]])=>t)}get routePath(){return l(this,E)[0].map(([[,t]])=>t)[this.routeIndex].path}},nt=new WeakMap,E=new WeakMap,V=new WeakSet,ia=function(t){const a=l(this,E)[0][this.routeIndex][1][t],e=g(this,V,Dt).call(this,a);return e&&/\%/.test(e)?$t(e):e},na=function(){const t={},a=Object.keys(l(this,E)[0][this.routeIndex][1]);for(const e of a){const s=g(this,V,Dt).call(this,l(this,E)[0][this.routeIndex][1][e]);s!==void 0&&(t[e]=/\%/.test(s)?$t(s):s)}return t},Dt=function(t){return l(this,E)[1]?l(this,E)[1][t]:t},_=new WeakMap,Jt),Fa={Stringify:1},ra=async(t,a,e,s,i)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(i?i[0]+=t:i=[t],Promise.all(n.map(c=>c({phase:a,buffer:i,context:s}))).then(c=>Promise.all(c.filter(Boolean).map(o=>ra(o,a,!1,s,i))).then(()=>i[0]))):Promise.resolve(t)},Ma="text/plain; charset=UTF-8",Mt=(t,a)=>({"Content-Type":t,...a}),xt,gt,F,rt,M,T,vt,lt,dt,K,bt,yt,$,st,Gt,Da=(Gt=class{constructor(t,a){x(this,$);x(this,xt);x(this,gt);u(this,"env",{});x(this,F);u(this,"finalized",!1);u(this,"error");x(this,rt);x(this,M);x(this,T);x(this,vt);x(this,lt);x(this,dt);x(this,K);x(this,bt);x(this,yt);u(this,"render",(...t)=>(l(this,lt)??m(this,lt,a=>this.html(a)),l(this,lt).call(this,...t)));u(this,"setLayout",t=>m(this,vt,t));u(this,"getLayout",()=>l(this,vt));u(this,"setRenderer",t=>{m(this,lt,t)});u(this,"header",(t,a,e)=>{this.finalized&&m(this,T,new Response(l(this,T).body,l(this,T)));const s=l(this,T)?l(this,T).headers:l(this,K)??m(this,K,new Headers);a===void 0?s.delete(t):e!=null&&e.append?s.append(t,a):s.set(t,a)});u(this,"status",t=>{m(this,rt,t)});u(this,"set",(t,a)=>{l(this,F)??m(this,F,new Map),l(this,F).set(t,a)});u(this,"get",t=>l(this,F)?l(this,F).get(t):void 0);u(this,"newResponse",(...t)=>g(this,$,st).call(this,...t));u(this,"body",(t,a,e)=>g(this,$,st).call(this,t,a,e));u(this,"text",(t,a,e)=>!l(this,K)&&!l(this,rt)&&!a&&!e&&!this.finalized?new Response(t):g(this,$,st).call(this,t,a,Mt(Ma,e)));u(this,"json",(t,a,e)=>g(this,$,st).call(this,JSON.stringify(t),a,Mt("application/json",e)));u(this,"html",(t,a,e)=>{const s=i=>g(this,$,st).call(this,i,a,Mt("text/html; charset=UTF-8",e));return typeof t=="object"?ra(t,Fa.Stringify,!1,{}).then(s):s(t)});u(this,"redirect",(t,a)=>{const e=String(t);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,a??302)});u(this,"notFound",()=>(l(this,dt)??m(this,dt,()=>new Response),l(this,dt).call(this,this)));m(this,xt,t),a&&(m(this,M,a.executionCtx),this.env=a.env,m(this,dt,a.notFoundHandler),m(this,yt,a.path),m(this,bt,a.matchResult))}get req(){return l(this,gt)??m(this,gt,new sa(l(this,xt),l(this,yt),l(this,bt))),l(this,gt)}get event(){if(l(this,M)&&"respondWith"in l(this,M))return l(this,M);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,M))return l(this,M);throw Error("This context has no ExecutionContext")}get res(){return l(this,T)||m(this,T,new Response(null,{headers:l(this,K)??m(this,K,new Headers)}))}set res(t){if(l(this,T)&&t){t=new Response(t.body,t);for(const[a,e]of l(this,T).headers.entries())if(a!=="content-type")if(a==="set-cookie"){const s=l(this,T).headers.getSetCookie();t.headers.delete("set-cookie");for(const i of s)t.headers.append("set-cookie",i)}else t.headers.set(a,e)}m(this,T,t),this.finalized=!0}get var(){return l(this,F)?Object.fromEntries(l(this,F)):{}}},xt=new WeakMap,gt=new WeakMap,F=new WeakMap,rt=new WeakMap,M=new WeakMap,T=new WeakMap,vt=new WeakMap,lt=new WeakMap,dt=new WeakMap,K=new WeakMap,bt=new WeakMap,yt=new WeakMap,$=new WeakSet,st=function(t,a,e){const s=l(this,T)?new Headers(l(this,T).headers):l(this,K)??new Headers;if(typeof a=="object"&&"headers"in a){const n=a.headers instanceof Headers?a.headers:new Headers(a.headers);for(const[r,c]of n)r.toLowerCase()==="set-cookie"?s.append(r,c):s.set(r,c)}if(e)for(const[n,r]of Object.entries(e))if(typeof r=="string")s.set(n,r);else{s.delete(n);for(const c of r)s.append(n,c)}const i=typeof a=="number"?a:(a==null?void 0:a.status)??l(this,rt);return new Response(t,{status:i,headers:s})},Gt),j="ALL",Na="all",Va=["get","post","put","delete","options","patch"],la="Can not add a route since the matcher is already built.",da=class extends Error{},Ba="__COMPOSED_HANDLER",Ha=t=>t.text("404 Not Found",404),zt=(t,a)=>{if("getResponse"in t){const e=t.getResponse();return a.newResponse(e.body,e)}return console.error(t),a.text("Internal Server Error",500)},A,w,oa,O,G,Tt,Et,ot,_a=(ot=class{constructor(a={}){x(this,w);u(this,"get");u(this,"post");u(this,"put");u(this,"delete");u(this,"options");u(this,"patch");u(this,"all");u(this,"on");u(this,"use");u(this,"router");u(this,"getPath");u(this,"_basePath","/");x(this,A,"/");u(this,"routes",[]);x(this,O,Ha);u(this,"errorHandler",zt);u(this,"onError",a=>(this.errorHandler=a,this));u(this,"notFound",a=>(m(this,O,a),this));u(this,"fetch",(a,...e)=>g(this,w,Et).call(this,a,e[1],e[0],a.method));u(this,"request",(a,e,s,i)=>a instanceof Request?this.fetch(e?new Request(a,e):a,s,i):(a=a.toString(),this.fetch(new Request(/^https?:\/\//.test(a)?a:`http://localhost${et("/",a)}`,e),s,i)));u(this,"fire",()=>{addEventListener("fetch",a=>{a.respondWith(g(this,w,Et).call(this,a.request,a,void 0,a.request.method))})});[...Va,Na].forEach(n=>{this[n]=(r,...c)=>(typeof r=="string"?m(this,A,r):g(this,w,G).call(this,n,l(this,A),r),c.forEach(o=>{g(this,w,G).call(this,n,l(this,A),o)}),this)}),this.on=(n,r,...c)=>{for(const o of[r].flat()){m(this,A,o);for(const d of[n].flat())c.map(p=>{g(this,w,G).call(this,d.toUpperCase(),l(this,A),p)})}return this},this.use=(n,...r)=>(typeof n=="string"?m(this,A,n):(m(this,A,"*"),r.unshift(n)),r.forEach(c=>{g(this,w,G).call(this,j,l(this,A),c)}),this);const{strict:s,...i}=a;Object.assign(this,i),this.getPath=s??!0?a.getPath??Zt:Ia}route(a,e){const s=this.basePath(a);return e.routes.map(i=>{var r;let n;e.errorHandler===zt?n=i.handler:(n=async(c,o)=>(await _t([],e.errorHandler)(c,()=>i.handler(c,o))).res,n[Ba]=i.handler),g(r=s,w,G).call(r,i.method,i.path,n)}),this}basePath(a){const e=g(this,w,oa).call(this);return e._basePath=et(this._basePath,a),e}mount(a,e,s){let i,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?i=o=>o:i=s.replaceRequest));const r=n?o=>{const d=n(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};i||(i=(()=>{const o=et(this._basePath,a),d=o==="/"?0:o.length;return p=>{const f=new URL(p.url);return f.pathname=f.pathname.slice(d)||"/",new Request(f,p)}})());const c=async(o,d)=>{const p=await e(i(o.req.raw),...r(o));if(p)return p;await d()};return g(this,w,G).call(this,j,et(a,"*"),c),this}},A=new WeakMap,w=new WeakSet,oa=function(){const a=new ot({router:this.router,getPath:this.getPath});return a.errorHandler=this.errorHandler,m(a,O,l(this,O)),a.routes=this.routes,a},O=new WeakMap,G=function(a,e,s){a=a.toUpperCase(),e=et(this._basePath,e);const i={basePath:this._basePath,path:e,method:a,handler:s};this.router.add(a,e,[s,i]),this.routes.push(i)},Tt=function(a,e){if(a instanceof Error)return this.errorHandler(a,e);throw a},Et=function(a,e,s,i){if(i==="HEAD")return(async()=>new Response(null,await g(this,w,Et).call(this,a,e,s,"GET")))();const n=this.getPath(a,{env:s}),r=this.router.match(i,n),c=new Da(a,{path:n,matchResult:r,env:s,executionCtx:e,notFoundHandler:l(this,O)});if(r[0].length===1){let d;try{d=r[0][0][0][0](c,async()=>{c.res=await l(this,O).call(this,c)})}catch(p){return g(this,w,Tt).call(this,p,c)}return d instanceof Promise?d.then(p=>p||(c.finalized?c.res:l(this,O).call(this,c))).catch(p=>g(this,w,Tt).call(this,p,c)):d??l(this,O).call(this,c)}const o=_t(r[0],this.errorHandler,l(this,O));return(async()=>{try{const d=await o(c);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return g(this,w,Tt).call(this,d,c)}})()},ot),ca=[];function $a(t,a){const e=this.buildAllMatchers(),s=((i,n)=>{const r=e[i]||e[j],c=r[2][n];if(c)return c;const o=n.match(r[0]);if(!o)return[[],ca];const d=o.indexOf("",1);return[r[1][d],o]});return this.match=s,s(t,a)}var Ot="[^/]+",ut=".*",ht="(?:|/.*)",it=Symbol(),za=new Set(".\\+*[^]$()");function Ua(t,a){return t.length===1?a.length===1?t<a?-1:1:-1:a.length===1||t===ut||t===ht?1:a===ut||a===ht?-1:t===Ot?1:a===Ot?-1:t.length===a.length?t<a?-1:1:a.length-t.length}var Y,Q,C,tt,qa=(tt=class{constructor(){x(this,Y);x(this,Q);x(this,C,Object.create(null))}insert(a,e,s,i,n){if(a.length===0){if(l(this,Y)!==void 0)throw it;if(n)return;m(this,Y,e);return}const[r,...c]=a,o=r==="*"?c.length===0?["","",ut]:["","",Ot]:r==="/*"?["","",ht]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const p=o[1];let f=o[2]||Ot;if(p&&o[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw it;if(d=l(this,C)[f],!d){if(Object.keys(l(this,C)).some(h=>h!==ut&&h!==ht))throw it;if(n)return;d=l(this,C)[f]=new tt,p!==""&&m(d,Q,i.varIndex++)}!n&&p!==""&&s.push([p,l(d,Q)])}else if(d=l(this,C)[r],!d){if(Object.keys(l(this,C)).some(p=>p.length>1&&p!==ut&&p!==ht))throw it;if(n)return;d=l(this,C)[r]=new tt}d.insert(c,e,s,i,n)}buildRegExpStr(){const e=Object.keys(l(this,C)).sort(Ua).map(s=>{const i=l(this,C)[s];return(typeof l(i,Q)=="number"?`(${s})@${l(i,Q)}`:za.has(s)?`\\${s}`:s)+i.buildRegExpStr()});return typeof l(this,Y)=="number"&&e.unshift(`#${l(this,Y)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},Y=new WeakMap,Q=new WeakMap,C=new WeakMap,tt),Ct,jt,Wt,Ja=(Wt=class{constructor(){x(this,Ct,{varIndex:0});x(this,jt,new qa)}insert(t,a,e){const s=[],i=[];for(let r=0;;){let c=!1;if(t=t.replace(/\{[^}]+\}/g,o=>{const d=`@\\${r}`;return i[r]=[d,o],r++,c=!0,d}),!c)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=i.length-1;r>=0;r--){const[c]=i[r];for(let o=n.length-1;o>=0;o--)if(n[o].indexOf(c)!==-1){n[o]=n[o].replace(c,i[r][1]);break}}return l(this,jt).insert(n,a,s,l(this,Ct),e),s}buildRegExp(){let t=l(this,jt).buildRegExpStr();if(t==="")return[/^$/,[],[]];let a=0;const e=[],s=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,r)=>n!==void 0?(e[++a]=Number(n),"$()"):(r!==void 0&&(s[Number(r)]=++a),"")),[new RegExp(`^${t}`),e,s]}},Ct=new WeakMap,jt=new WeakMap,Wt),Ga=[/^$/,[],Object.create(null)],At=Object.create(null);function pa(t){return At[t]??(At[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(a,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function Wa(){At=Object.create(null)}function Ka(t){var d;const a=new Ja,e=[];if(t.length===0)return Ga;const s=t.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,f],[h,b])=>p?1:h?-1:f.length-b.length),i=Object.create(null);for(let p=0,f=-1,h=s.length;p<h;p++){const[b,y,I]=s[p];b?i[y]=[I.map(([S])=>[S,Object.create(null)]),ca]:f++;let v;try{v=a.insert(y,f,b)}catch(S){throw S===it?new da(y):S}b||(e[f]=I.map(([S,B])=>{const St=Object.create(null);for(B-=1;B>=0;B--){const[Rt,P]=v[B];St[Rt]=P}return[S,St]}))}const[n,r,c]=a.buildRegExp();for(let p=0,f=e.length;p<f;p++)for(let h=0,b=e[p].length;h<b;h++){const y=(d=e[p][h])==null?void 0:d[1];if(!y)continue;const I=Object.keys(y);for(let v=0,S=I.length;v<S;v++)y[I[v]]=c[y[I[v]]]}const o=[];for(const p in r)o[p]=e[r[p]];return[n,o,i]}function at(t,a){if(t){for(const e of Object.keys(t).sort((s,i)=>i.length-s.length))if(pa(e).test(a))return[...t[e]]}}var z,U,It,fa,Kt,Ya=(Kt=class{constructor(){x(this,It);u(this,"name","RegExpRouter");x(this,z);x(this,U);u(this,"match",$a);m(this,z,{[j]:Object.create(null)}),m(this,U,{[j]:Object.create(null)})}add(t,a,e){var c;const s=l(this,z),i=l(this,U);if(!s||!i)throw new Error(la);s[t]||[s,i].forEach(o=>{o[t]=Object.create(null),Object.keys(o[j]).forEach(d=>{o[t][d]=[...o[j][d]]})}),a==="/*"&&(a="*");const n=(a.match(/\/:/g)||[]).length;if(/\*$/.test(a)){const o=pa(a);t===j?Object.keys(s).forEach(d=>{var p;(p=s[d])[a]||(p[a]=at(s[d],a)||at(s[j],a)||[])}):(c=s[t])[a]||(c[a]=at(s[t],a)||at(s[j],a)||[]),Object.keys(s).forEach(d=>{(t===j||t===d)&&Object.keys(s[d]).forEach(p=>{o.test(p)&&s[d][p].push([e,n])})}),Object.keys(i).forEach(d=>{(t===j||t===d)&&Object.keys(i[d]).forEach(p=>o.test(p)&&i[d][p].push([e,n]))});return}const r=ta(a)||[a];for(let o=0,d=r.length;o<d;o++){const p=r[o];Object.keys(i).forEach(f=>{var h;(t===j||t===f)&&((h=i[f])[p]||(h[p]=[...at(s[f],p)||at(s[j],p)||[]]),i[f][p].push([e,n-d+o+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(l(this,U)).concat(Object.keys(l(this,z))).forEach(a=>{t[a]||(t[a]=g(this,It,fa).call(this,a))}),m(this,z,m(this,U,void 0)),Wa(),t}},z=new WeakMap,U=new WeakMap,It=new WeakSet,fa=function(t){const a=[];let e=t===j;return[l(this,z),l(this,U)].forEach(s=>{const i=s[t]?Object.keys(s[t]).map(n=>[n,s[t][n]]):[];i.length!==0?(e||(e=!0),a.push(...i)):t!==j&&a.push(...Object.keys(s[j]).map(n=>[n,s[j][n]]))}),e?Ka(a):null},Kt),q,D,Yt,Qa=(Yt=class{constructor(t){u(this,"name","SmartRouter");x(this,q,[]);x(this,D,[]);m(this,q,t.routers)}add(t,a,e){if(!l(this,D))throw new Error(la);l(this,D).push([t,a,e])}match(t,a){if(!l(this,D))throw new Error("Fatal error");const e=l(this,q),s=l(this,D),i=e.length;let n=0,r;for(;n<i;n++){const c=e[n];try{for(let o=0,d=s.length;o<d;o++)c.add(...s[o]);r=c.match(t,a)}catch(o){if(o instanceof da)continue;throw o}this.match=c.match.bind(c),m(this,q,[c]),m(this,D,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(l(this,D)||l(this,q).length!==1)throw new Error("No active router has been determined yet.");return l(this,q)[0]}},q=new WeakMap,D=new WeakMap,Yt),mt=Object.create(null),J,k,X,ct,R,N,W,pt,Xa=(pt=class{constructor(a,e,s){x(this,N);x(this,J);x(this,k);x(this,X);x(this,ct,0);x(this,R,mt);if(m(this,k,s||Object.create(null)),m(this,J,[]),a&&e){const i=Object.create(null);i[a]={handler:e,possibleKeys:[],score:0},m(this,J,[i])}m(this,X,[])}insert(a,e,s){m(this,ct,++Ht(this,ct)._);let i=this;const n=Ta(e),r=[];for(let c=0,o=n.length;c<o;c++){const d=n[c],p=n[c+1],f=Oa(d,p),h=Array.isArray(f)?f[0]:d;if(h in l(i,k)){i=l(i,k)[h],f&&r.push(f[1]);continue}l(i,k)[h]=new pt,f&&(l(i,X).push(f),r.push(f[1])),i=l(i,k)[h]}return l(i,J).push({[a]:{handler:s,possibleKeys:r.filter((c,o,d)=>d.indexOf(c)===o),score:l(this,ct)}}),i}search(a,e){var o;const s=[];m(this,R,mt);let n=[this];const r=Xt(e),c=[];for(let d=0,p=r.length;d<p;d++){const f=r[d],h=d===p-1,b=[];for(let y=0,I=n.length;y<I;y++){const v=n[y],S=l(v,k)[f];S&&(m(S,R,l(v,R)),h?(l(S,k)["*"]&&s.push(...g(this,N,W).call(this,l(S,k)["*"],a,l(v,R))),s.push(...g(this,N,W).call(this,S,a,l(v,R)))):b.push(S));for(let B=0,St=l(v,X).length;B<St;B++){const Rt=l(v,X)[B],P=l(v,R)===mt?{}:{...l(v,R)};if(Rt==="*"){const H=l(v,k)["*"];H&&(s.push(...g(this,N,W).call(this,H,a,l(v,R))),m(H,R,P),b.push(H));continue}const[xa,Vt,ft]=Rt;if(!f&&!(ft instanceof RegExp))continue;const L=l(v,k)[xa],ga=r.slice(d).join("/");if(ft instanceof RegExp){const H=ft.exec(ga);if(H){if(P[Vt]=H[0],s.push(...g(this,N,W).call(this,L,a,l(v,R),P)),Object.keys(l(L,k)).length){m(L,R,P);const Pt=((o=H[0].match(/\//))==null?void 0:o.length)??0;(c[Pt]||(c[Pt]=[])).push(L)}continue}}(ft===!0||ft.test(f))&&(P[Vt]=f,h?(s.push(...g(this,N,W).call(this,L,a,P,l(v,R))),l(L,k)["*"]&&s.push(...g(this,N,W).call(this,l(L,k)["*"],a,P,l(v,R)))):(m(L,R,P),b.push(L)))}}n=b.concat(c.shift()??[])}return s.length>1&&s.sort((d,p)=>d.score-p.score),[s.map(({handler:d,params:p})=>[d,p])]}},J=new WeakMap,k=new WeakMap,X=new WeakMap,ct=new WeakMap,R=new WeakMap,N=new WeakSet,W=function(a,e,s,i){const n=[];for(let r=0,c=l(a,J).length;r<c;r++){const o=l(a,J)[r],d=o[e]||o[j],p={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),s!==mt||i&&i!==mt))for(let f=0,h=d.possibleKeys.length;f<h;f++){const b=d.possibleKeys[f],y=p[d.score];d.params[b]=i!=null&&i[b]&&!y?i[b]:s[b]??(i==null?void 0:i[b]),p[d.score]=!0}}return n},pt),Z,Qt,Za=(Qt=class{constructor(){u(this,"name","TrieRouter");x(this,Z);m(this,Z,new Xa)}add(t,a,e){const s=ta(a);if(s){for(let i=0,n=s.length;i<n;i++)l(this,Z).insert(t,s[i],e);return}l(this,Z).insert(t,a,e)}match(t,a){return l(this,Z).search(t,a)}},Z=new WeakMap,Qt),ma=class extends _a{constructor(t={}){super(t),this.router=t.router??new Qa({routers:[new Ya,new Za]})}},te=t=>{const e={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...t},s=(n=>typeof n=="string"?n==="*"?()=>n:r=>n===r?r:null:typeof n=="function"?n:r=>n.includes(r)?r:null)(e.origin),i=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(e.allowMethods);return async function(r,c){var p;function o(f,h){r.res.headers.set(f,h)}const d=await s(r.req.header("origin")||"",r);if(d&&o("Access-Control-Allow-Origin",d),e.credentials&&o("Access-Control-Allow-Credentials","true"),(p=e.exposeHeaders)!=null&&p.length&&o("Access-Control-Expose-Headers",e.exposeHeaders.join(",")),r.req.method==="OPTIONS"){e.origin!=="*"&&o("Vary","Origin"),e.maxAge!=null&&o("Access-Control-Max-Age",e.maxAge.toString());const f=await i(r.req.header("origin")||"",r);f.length&&o("Access-Control-Allow-Methods",f.join(","));let h=e.allowHeaders;if(!(h!=null&&h.length)){const b=r.req.header("Access-Control-Request-Headers");b&&(h=b.split(/\s*,\s*/))}return h!=null&&h.length&&(o("Access-Control-Allow-Headers",h.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await c(),e.origin!=="*"&&r.header("Vary","Origin",{append:!0})}},ae=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Ut=(t,a=se)=>{const e=/\.([a-zA-Z0-9]+?)$/,s=t.match(e);if(!s)return;let i=a[s[1]];return i&&i.startsWith("text")&&(i+="; charset=utf-8"),i},ee={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},se=ee,ie=(...t)=>{let a=t.filter(i=>i!=="").join("/");a=a.replace(new RegExp("(?<=\\/)\\/+","g"),"");const e=a.split("/"),s=[];for(const i of e)i===".."&&s.length>0&&s.at(-1)!==".."?s.pop():i!=="."&&s.push(i);return s.join("/")||"."},ua={br:".br",zstd:".zst",gzip:".gz"},ne=Object.keys(ua),re="index.html",le=t=>{const a=t.root??"./",e=t.path,s=t.join??ie;return async(i,n)=>{var p,f,h,b;if(i.finalized)return n();let r;if(t.path)r=t.path;else try{if(r=decodeURIComponent(i.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(r))throw new Error}catch{return await((p=t.onNotFound)==null?void 0:p.call(t,i.req.path,i)),n()}let c=s(a,!e&&t.rewriteRequestPath?t.rewriteRequestPath(r):r);t.isDir&&await t.isDir(c)&&(c=s(c,re));const o=t.getContent;let d=await o(c,i);if(d instanceof Response)return i.newResponse(d.body,d);if(d){const y=t.mimes&&Ut(c,t.mimes)||Ut(c);if(i.header("Content-Type",y||"application/octet-stream"),t.precompressed&&(!y||ae.test(y))){const I=new Set((f=i.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(v=>v.trim()));for(const v of ne){if(!I.has(v))continue;const S=await o(c+ua[v],i);if(S){d=S,i.header("Content-Encoding",v),i.header("Vary","Accept-Encoding",{append:!0});break}}}return await((h=t.onFound)==null?void 0:h.call(t,c,i)),i.body(d)}await((b=t.onNotFound)==null?void 0:b.call(t,c,i)),await n()}},de=async(t,a)=>{let e;a&&a.manifest?typeof a.manifest=="string"?e=JSON.parse(a.manifest):e=a.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?e=JSON.parse(__STATIC_CONTENT_MANIFEST):e=__STATIC_CONTENT_MANIFEST;let s;a&&a.namespace?s=a.namespace:s=__STATIC_CONTENT;const i=e[t]||t;if(!i)return null;const n=await s.get(i,{type:"stream"});return n||null},oe=t=>async function(e,s){return le({...t,getContent:async n=>de(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:e.env?e.env.__STATIC_CONTENT:void 0})})(e,s)},ce=t=>oe(t);const wt=new ma;wt.use("/api/*",te());wt.use("/static/*",ce({root:"./public"}));wt.post("/api/contact",async t=>{var a;try{const e=await t.req.json(),{name:s,email:i,organization:n,phone:r,message:c,type:o,language:d}=e;if(!s||!i||!c)return t.json({success:!1,error:"Required fields are missing"},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))return t.json({success:!1,error:"Invalid email format"},400);console.log("Contact form submission:",{name:s,email:i,organization:n,phone:r,message:c,type:o,language:d});const f=d==="ja"?`【VALORISE】新規お問い合わせ - ${s}様`:`[VALORISE] New Inquiry - ${s}`,h=`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
【お問い合わせ種別】
${o==="team"?"チーム測定":o==="individual"?"個人測定":o==="consultation"?"相談・見積もり":"その他"}
