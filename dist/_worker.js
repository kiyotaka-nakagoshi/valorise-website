var va=Object.defineProperty;var Bt=t=>{throw TypeError(t)};var ba=(t,a,e)=>a in t?va(t,a,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[a]=e;var h=(t,a,e)=>ba(t,typeof a!="symbol"?a+"":a,e),Lt=(t,a,e)=>a.has(t)||Bt("Cannot "+e);var l=(t,a,e)=>(Lt(t,a,"read from private field"),e?e.call(t):a.get(t)),x=(t,a,e)=>a.has(t)?Bt("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,e),u=(t,a,e,s)=>(Lt(t,a,"write to private field"),s?s.call(t,e):a.set(t,e),e),g=(t,a,e)=>(Lt(t,a,"access private method"),e);var _t=(t,a,e,s)=>({set _(i){u(t,a,i,e)},get _(){return l(t,a,s)}});var Ht=(t,a,e)=>(s,i)=>{let n=-1;return r(0);async function r(c){if(c<=n)throw new Error("next() called multiple times");n=c;let d,o=!1,p;if(t[c]?(p=t[c][0][0],s.req.routeIndex=c):p=c===t.length&&i||void 0,p)try{d=await p(s,()=>r(c+1))}catch(f){if(f instanceof Error&&a)s.error=f,d=await a(f,s),o=!0;else throw f}else s.finalized===!1&&e&&(d=await e(s));return d&&(s.finalized===!1||o)&&(s.res=d),s}},ya=Symbol(),ja=async(t,a=Object.create(null))=>{const{all:e=!1,dot:s=!1}=a,n=(t instanceof sa?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?wa(t,{all:e,dot:s}):{}};async function wa(t,a){const e=await t.formData();return e?Sa(e,a):{}}function Sa(t,a){const e=Object.create(null);return t.forEach((s,i)=>{a.all||i.endsWith("[]")?Ra(e,i,s):e[i]=s}),a.dot&&Object.entries(e).forEach(([s,i])=>{s.includes(".")&&(Ea(e,s,i),delete e[s])}),e}var Ra=(t,a,e)=>{t[a]!==void 0?Array.isArray(t[a])?t[a].push(e):t[a]=[t[a],e]:a.endsWith("[]")?t[a]=[e]:t[a]=e},Ea=(t,a,e)=>{let s=t;const i=a.split(".");i.forEach((n,r)=>{r===i.length-1?s[n]=e:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},Xt=t=>{const a=t.split("/");return a[0]===""&&a.shift(),a},Ta=t=>{const{groups:a,path:e}=ka(t),s=Xt(e);return Aa(s,a)},ka=t=>{const a=[];return t=t.replace(/\{[^}]+\}/g,(e,s)=>{const i=`@${s}`;return a.push([i,e]),i}),{groups:a,path:t}},Aa=(t,a)=>{for(let e=a.length-1;e>=0;e--){const[s]=a[e];for(let i=t.length-1;i>=0;i--)if(t[i].includes(s)){t[i]=t[i].replace(s,a[e][1]);break}}return t},Et={},Oa=(t,a)=>{if(t==="*")return"*";const e=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(e){const s=`${t}#${a}`;return Et[s]||(e[2]?Et[s]=a&&a[0]!==":"&&a[0]!=="*"?[s,e[1],new RegExp(`^${e[2]}(?=/${a})`)]:[t,e[1],new RegExp(`^${e[2]}$`)]:Et[s]=[t,e[1],!0]),Et[s]}return null},Nt=(t,a)=>{try{return a(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,e=>{try{return a(e)}catch{return e}})}},Ca=t=>Nt(t,decodeURI),Zt=t=>{const a=t.url,e=a.indexOf("/",a.indexOf(":")+4);let s=e;for(;s<a.length;s++){const i=a.charCodeAt(s);if(i===37){const n=a.indexOf("?",s),r=a.slice(e,n===-1?void 0:n);return Ca(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(i===63)break}return a.slice(e,s)},Pa=t=>{const a=Zt(t);return a.length>1&&a.at(-1)==="/"?a.slice(0,-1):a},et=(t,a,...e)=>(e.length&&(a=et(a,...e)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${a==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(a==null?void 0:a[0])==="/"?a.slice(1):a}`}`),ta=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const a=t.split("/"),e=[];let s="";return a.forEach(i=>{if(i!==""&&!/\:/.test(i))s+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){e.length===0&&s===""?e.push("/"):e.push(s);const n=i.replace("?","");s+="/"+n,e.push(s)}else s+="/"+i}),e.filter((i,n,r)=>r.indexOf(i)===n)},Ft=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Nt(t,ea):t):t,aa=(t,a,e)=>{let s;if(!e&&a&&!/[%+]/.test(a)){let r=t.indexOf("?",8);if(r===-1)return;for(t.startsWith(a,r+1)||(r=t.indexOf(`&${a}`,r+1));r!==-1;){const c=t.charCodeAt(r+a.length+1);if(c===61){const d=r+a.length+2,o=t.indexOf("&",d);return Ft(t.slice(d,o===-1?void 0:o))}else if(c==38||isNaN(c))return"";r=t.indexOf(`&${a}`,r+1)}if(s=/[%+]/.test(t),!s)return}const i={};s??(s=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const r=t.indexOf("&",n+1);let c=t.indexOf("=",n);c>r&&r!==-1&&(c=-1);let d=t.slice(n+1,c===-1?r===-1?void 0:r:c);if(s&&(d=Ft(d)),n=r,d==="")continue;let o;c===-1?o="":(o=t.slice(c+1,r===-1?void 0:r),s&&(o=Ft(o))),e?(i[d]&&Array.isArray(i[d])||(i[d]=[]),i[d].push(o)):i[d]??(i[d]=o)}return a?i[a]:i},Ia=aa,La=(t,a)=>aa(t,a,!0),ea=decodeURIComponent,$t=t=>Nt(t,ea),nt,k,V,ia,na,Dt,H,qt,sa=(qt=class{constructor(t,a="/",e=[[]]){x(this,V);h(this,"raw");x(this,nt);x(this,k);h(this,"routeIndex",0);h(this,"path");h(this,"bodyCache",{});x(this,H,t=>{const{bodyCache:a,raw:e}=this,s=a[t];if(s)return s;const i=Object.keys(a)[0];return i?a[i].then(n=>(i==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):a[t]=e[t]()});this.raw=t,this.path=a,u(this,k,e),u(this,nt,{})}param(t){return t?g(this,V,ia).call(this,t):g(this,V,na).call(this)}query(t){return Ia(this.url,t)}queries(t){return La(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const a={};return this.raw.headers.forEach((e,s)=>{a[s]=e}),a}async parseBody(t){var a;return(a=this.bodyCache).parsedBody??(a.parsedBody=await ja(this,t))}json(){return l(this,H).call(this,"text").then(t=>JSON.parse(t))}text(){return l(this,H).call(this,"text")}arrayBuffer(){return l(this,H).call(this,"arrayBuffer")}blob(){return l(this,H).call(this,"blob")}formData(){return l(this,H).call(this,"formData")}addValidatedData(t,a){l(this,nt)[t]=a}valid(t){return l(this,nt)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ya](){return l(this,k)}get matchedRoutes(){return l(this,k)[0].map(([[,t]])=>t)}get routePath(){return l(this,k)[0].map(([[,t]])=>t)[this.routeIndex].path}},nt=new WeakMap,k=new WeakMap,V=new WeakSet,ia=function(t){const a=l(this,k)[0][this.routeIndex][1][t],e=g(this,V,Dt).call(this,a);return e&&/\%/.test(e)?$t(e):e},na=function(){const t={},a=Object.keys(l(this,k)[0][this.routeIndex][1]);for(const e of a){const s=g(this,V,Dt).call(this,l(this,k)[0][this.routeIndex][1][e]);s!==void 0&&(t[e]=/\%/.test(s)?$t(s):s)}return t},Dt=function(t){return l(this,k)[1]?l(this,k)[1][t]:t},H=new WeakMap,qt),Fa={Stringify:1},ra=async(t,a,e,s,i)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(i?i[0]+=t:i=[t],Promise.all(n.map(c=>c({phase:a,buffer:i,context:s}))).then(c=>Promise.all(c.filter(Boolean).map(d=>ra(d,a,!1,s,i))).then(()=>i[0]))):Promise.resolve(t)},Ma="text/plain; charset=UTF-8",Mt=(t,a)=>({"Content-Type":t,...a}),xt,gt,F,rt,M,T,vt,lt,ot,K,bt,yt,$,st,Wt,Da=(Wt=class{constructor(t,a){x(this,$);x(this,xt);x(this,gt);h(this,"env",{});x(this,F);h(this,"finalized",!1);h(this,"error");x(this,rt);x(this,M);x(this,T);x(this,vt);x(this,lt);x(this,ot);x(this,K);x(this,bt);x(this,yt);h(this,"render",(...t)=>(l(this,lt)??u(this,lt,a=>this.html(a)),l(this,lt).call(this,...t)));h(this,"setLayout",t=>u(this,vt,t));h(this,"getLayout",()=>l(this,vt));h(this,"setRenderer",t=>{u(this,lt,t)});h(this,"header",(t,a,e)=>{this.finalized&&u(this,T,new Response(l(this,T).body,l(this,T)));const s=l(this,T)?l(this,T).headers:l(this,K)??u(this,K,new Headers);a===void 0?s.delete(t):e!=null&&e.append?s.append(t,a):s.set(t,a)});h(this,"status",t=>{u(this,rt,t)});h(this,"set",(t,a)=>{l(this,F)??u(this,F,new Map),l(this,F).set(t,a)});h(this,"get",t=>l(this,F)?l(this,F).get(t):void 0);h(this,"newResponse",(...t)=>g(this,$,st).call(this,...t));h(this,"body",(t,a,e)=>g(this,$,st).call(this,t,a,e));h(this,"text",(t,a,e)=>!l(this,K)&&!l(this,rt)&&!a&&!e&&!this.finalized?new Response(t):g(this,$,st).call(this,t,a,Mt(Ma,e)));h(this,"json",(t,a,e)=>g(this,$,st).call(this,JSON.stringify(t),a,Mt("application/json",e)));h(this,"html",(t,a,e)=>{const s=i=>g(this,$,st).call(this,i,a,Mt("text/html; charset=UTF-8",e));return typeof t=="object"?ra(t,Fa.Stringify,!1,{}).then(s):s(t)});h(this,"redirect",(t,a)=>{const e=String(t);return this.header("Location",/[^\x00-\xFF]/.test(e)?encodeURI(e):e),this.newResponse(null,a??302)});h(this,"notFound",()=>(l(this,ot)??u(this,ot,()=>new Response),l(this,ot).call(this,this)));u(this,xt,t),a&&(u(this,M,a.executionCtx),this.env=a.env,u(this,ot,a.notFoundHandler),u(this,yt,a.path),u(this,bt,a.matchResult))}get req(){return l(this,gt)??u(this,gt,new sa(l(this,xt),l(this,yt),l(this,bt))),l(this,gt)}get event(){if(l(this,M)&&"respondWith"in l(this,M))return l(this,M);throw Error("This context has no FetchEvent")}get executionCtx(){if(l(this,M))return l(this,M);throw Error("This context has no ExecutionContext")}get res(){return l(this,T)||u(this,T,new Response(null,{headers:l(this,K)??u(this,K,new Headers)}))}set res(t){if(l(this,T)&&t){t=new Response(t.body,t);for(const[a,e]of l(this,T).headers.entries())if(a!=="content-type")if(a==="set-cookie"){const s=l(this,T).headers.getSetCookie();t.headers.delete("set-cookie");for(const i of s)t.headers.append("set-cookie",i)}else t.headers.set(a,e)}u(this,T,t),this.finalized=!0}get var(){return l(this,F)?Object.fromEntries(l(this,F)):{}}},xt=new WeakMap,gt=new WeakMap,F=new WeakMap,rt=new WeakMap,M=new WeakMap,T=new WeakMap,vt=new WeakMap,lt=new WeakMap,ot=new WeakMap,K=new WeakMap,bt=new WeakMap,yt=new WeakMap,$=new WeakSet,st=function(t,a,e){const s=l(this,T)?new Headers(l(this,T).headers):l(this,K)??new Headers;if(typeof a=="object"&&"headers"in a){const n=a.headers instanceof Headers?a.headers:new Headers(a.headers);for(const[r,c]of n)r.toLowerCase()==="set-cookie"?s.append(r,c):s.set(r,c)}if(e)for(const[n,r]of Object.entries(e))if(typeof r=="string")s.set(n,r);else{s.delete(n);for(const c of r)s.append(n,c)}const i=typeof a=="number"?a:(a==null?void 0:a.status)??l(this,rt);return new Response(t,{status:i,headers:s})},Wt),j="ALL",Na="all",Va=["get","post","put","delete","options","patch"],la="Can not add a route since the matcher is already built.",oa=class extends Error{},Ba="__COMPOSED_HANDLER",_a=t=>t.text("404 Not Found",404),Ut=(t,a)=>{if("getResponse"in t){const e=t.getResponse();return a.newResponse(e.body,e)}return console.error(t),a.text("Internal Server Error",500)},A,w,da,O,W,Tt,kt,dt,Ha=(dt=class{constructor(a={}){x(this,w);h(this,"get");h(this,"post");h(this,"put");h(this,"delete");h(this,"options");h(this,"patch");h(this,"all");h(this,"on");h(this,"use");h(this,"router");h(this,"getPath");h(this,"_basePath","/");x(this,A,"/");h(this,"routes",[]);x(this,O,_a);h(this,"errorHandler",Ut);h(this,"onError",a=>(this.errorHandler=a,this));h(this,"notFound",a=>(u(this,O,a),this));h(this,"fetch",(a,...e)=>g(this,w,kt).call(this,a,e[1],e[0],a.method));h(this,"request",(a,e,s,i)=>a instanceof Request?this.fetch(e?new Request(a,e):a,s,i):(a=a.toString(),this.fetch(new Request(/^https?:\/\//.test(a)?a:`http://localhost${et("/",a)}`,e),s,i)));h(this,"fire",()=>{addEventListener("fetch",a=>{a.respondWith(g(this,w,kt).call(this,a.request,a,void 0,a.request.method))})});[...Va,Na].forEach(n=>{this[n]=(r,...c)=>(typeof r=="string"?u(this,A,r):g(this,w,W).call(this,n,l(this,A),r),c.forEach(d=>{g(this,w,W).call(this,n,l(this,A),d)}),this)}),this.on=(n,r,...c)=>{for(const d of[r].flat()){u(this,A,d);for(const o of[n].flat())c.map(p=>{g(this,w,W).call(this,o.toUpperCase(),l(this,A),p)})}return this},this.use=(n,...r)=>(typeof n=="string"?u(this,A,n):(u(this,A,"*"),r.unshift(n)),r.forEach(c=>{g(this,w,W).call(this,j,l(this,A),c)}),this);const{strict:s,...i}=a;Object.assign(this,i),this.getPath=s??!0?a.getPath??Zt:Pa}route(a,e){const s=this.basePath(a);return e.routes.map(i=>{var r;let n;e.errorHandler===Ut?n=i.handler:(n=async(c,d)=>(await Ht([],e.errorHandler)(c,()=>i.handler(c,d))).res,n[Ba]=i.handler),g(r=s,w,W).call(r,i.method,i.path,n)}),this}basePath(a){const e=g(this,w,da).call(this);return e._basePath=et(this._basePath,a),e}mount(a,e,s){let i,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?i=d=>d:i=s.replaceRequest));const r=n?d=>{const o=n(d);return Array.isArray(o)?o:[o]}:d=>{let o;try{o=d.executionCtx}catch{}return[d.env,o]};i||(i=(()=>{const d=et(this._basePath,a),o=d==="/"?0:d.length;return p=>{const f=new URL(p.url);return f.pathname=f.pathname.slice(o)||"/",new Request(f,p)}})());const c=async(d,o)=>{const p=await e(i(d.req.raw),...r(d));if(p)return p;await o()};return g(this,w,W).call(this,j,et(a,"*"),c),this}},A=new WeakMap,w=new WeakSet,da=function(){const a=new dt({router:this.router,getPath:this.getPath});return a.errorHandler=this.errorHandler,u(a,O,l(this,O)),a.routes=this.routes,a},O=new WeakMap,W=function(a,e,s){a=a.toUpperCase(),e=et(this._basePath,e);const i={basePath:this._basePath,path:e,method:a,handler:s};this.router.add(a,e,[s,i]),this.routes.push(i)},Tt=function(a,e){if(a instanceof Error)return this.errorHandler(a,e);throw a},kt=function(a,e,s,i){if(i==="HEAD")return(async()=>new Response(null,await g(this,w,kt).call(this,a,e,s,"GET")))();const n=this.getPath(a,{env:s}),r=this.router.match(i,n),c=new Da(a,{path:n,matchResult:r,env:s,executionCtx:e,notFoundHandler:l(this,O)});if(r[0].length===1){let o;try{o=r[0][0][0][0](c,async()=>{c.res=await l(this,O).call(this,c)})}catch(p){return g(this,w,Tt).call(this,p,c)}return o instanceof Promise?o.then(p=>p||(c.finalized?c.res:l(this,O).call(this,c))).catch(p=>g(this,w,Tt).call(this,p,c)):o??l(this,O).call(this,c)}const d=Ht(r[0],this.errorHandler,l(this,O));return(async()=>{try{const o=await d(c);if(!o.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return o.res}catch(o){return g(this,w,Tt).call(this,o,c)}})()},dt),ca=[];function $a(t,a){const e=this.buildAllMatchers(),s=((i,n)=>{const r=e[i]||e[j],c=r[2][n];if(c)return c;const d=n.match(r[0]);if(!d)return[[],ca];const o=d.indexOf("",1);return[r[1][o],d]});return this.match=s,s(t,a)}var Ot="[^/]+",ht=".*",mt="(?:|/.*)",it=Symbol(),Ua=new Set(".\\+*[^]$()");function za(t,a){return t.length===1?a.length===1?t<a?-1:1:-1:a.length===1||t===ht||t===mt?1:a===ht||a===mt?-1:t===Ot?1:a===Ot?-1:t.length===a.length?t<a?-1:1:a.length-t.length}var Y,Q,C,tt,Ja=(tt=class{constructor(){x(this,Y);x(this,Q);x(this,C,Object.create(null))}insert(a,e,s,i,n){if(a.length===0){if(l(this,Y)!==void 0)throw it;if(n)return;u(this,Y,e);return}const[r,...c]=a,d=r==="*"?c.length===0?["","",ht]:["","",Ot]:r==="/*"?["","",mt]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let o;if(d){const p=d[1];let f=d[2]||Ot;if(p&&d[2]&&(f===".*"||(f=f.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(f))))throw it;if(o=l(this,C)[f],!o){if(Object.keys(l(this,C)).some(m=>m!==ht&&m!==mt))throw it;if(n)return;o=l(this,C)[f]=new tt,p!==""&&u(o,Q,i.varIndex++)}!n&&p!==""&&s.push([p,l(o,Q)])}else if(o=l(this,C)[r],!o){if(Object.keys(l(this,C)).some(p=>p.length>1&&p!==ht&&p!==mt))throw it;if(n)return;o=l(this,C)[r]=new tt}o.insert(c,e,s,i,n)}buildRegExpStr(){const e=Object.keys(l(this,C)).sort(za).map(s=>{const i=l(this,C)[s];return(typeof l(i,Q)=="number"?`(${s})@${l(i,Q)}`:Ua.has(s)?`\\${s}`:s)+i.buildRegExpStr()});return typeof l(this,Y)=="number"&&e.unshift(`#${l(this,Y)}`),e.length===0?"":e.length===1?e[0]:"(?:"+e.join("|")+")"}},Y=new WeakMap,Q=new WeakMap,C=new WeakMap,tt),Ct,jt,Gt,qa=(Gt=class{constructor(){x(this,Ct,{varIndex:0});x(this,jt,new Ja)}insert(t,a,e){const s=[],i=[];for(let r=0;;){let c=!1;if(t=t.replace(/\{[^}]+\}/g,d=>{const o=`@\\${r}`;return i[r]=[o,d],r++,c=!0,o}),!c)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=i.length-1;r>=0;r--){const[c]=i[r];for(let d=n.length-1;d>=0;d--)if(n[d].indexOf(c)!==-1){n[d]=n[d].replace(c,i[r][1]);break}}return l(this,jt).insert(n,a,s,l(this,Ct),e),s}buildRegExp(){let t=l(this,jt).buildRegExpStr();if(t==="")return[/^$/,[],[]];let a=0;const e=[],s=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,n,r)=>n!==void 0?(e[++a]=Number(n),"$()"):(r!==void 0&&(s[Number(r)]=++a),"")),[new RegExp(`^${t}`),e,s]}},Ct=new WeakMap,jt=new WeakMap,Gt),Wa=[/^$/,[],Object.create(null)],At=Object.create(null);function pa(t){return At[t]??(At[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(a,e)=>e?`\\${e}`:"(?:|/.*)")}$`))}function Ga(){At=Object.create(null)}function Ka(t){var o;const a=new qa,e=[];if(t.length===0)return Wa;const s=t.map(p=>[!/\*|\/:/.test(p[0]),...p]).sort(([p,f],[m,b])=>p?1:m?-1:f.length-b.length),i=Object.create(null);for(let p=0,f=-1,m=s.length;p<m;p++){const[b,y,P]=s[p];b?i[y]=[P.map(([S])=>[S,Object.create(null)]),ca]:f++;let v;try{v=a.insert(y,f,b)}catch(S){throw S===it?new oa(y):S}b||(e[f]=P.map(([S,B])=>{const St=Object.create(null);for(B-=1;B>=0;B--){const[Rt,I]=v[B];St[Rt]=I}return[S,St]}))}const[n,r,c]=a.buildRegExp();for(let p=0,f=e.length;p<f;p++)for(let m=0,b=e[p].length;m<b;m++){const y=(o=e[p][m])==null?void 0:o[1];if(!y)continue;const P=Object.keys(y);for(let v=0,S=P.length;v<S;v++)y[P[v]]=c[y[P[v]]]}const d=[];for(const p in r)d[p]=e[r[p]];return[n,d,i]}function at(t,a){if(t){for(const e of Object.keys(t).sort((s,i)=>i.length-s.length))if(pa(e).test(a))return[...t[e]]}}var U,z,Pt,fa,Kt,Ya=(Kt=class{constructor(){x(this,Pt);h(this,"name","RegExpRouter");x(this,U);x(this,z);h(this,"match",$a);u(this,U,{[j]:Object.create(null)}),u(this,z,{[j]:Object.create(null)})}add(t,a,e){var c;const s=l(this,U),i=l(this,z);if(!s||!i)throw new Error(la);s[t]||[s,i].forEach(d=>{d[t]=Object.create(null),Object.keys(d[j]).forEach(o=>{d[t][o]=[...d[j][o]]})}),a==="/*"&&(a="*");const n=(a.match(/\/:/g)||[]).length;if(/\*$/.test(a)){const d=pa(a);t===j?Object.keys(s).forEach(o=>{var p;(p=s[o])[a]||(p[a]=at(s[o],a)||at(s[j],a)||[])}):(c=s[t])[a]||(c[a]=at(s[t],a)||at(s[j],a)||[]),Object.keys(s).forEach(o=>{(t===j||t===o)&&Object.keys(s[o]).forEach(p=>{d.test(p)&&s[o][p].push([e,n])})}),Object.keys(i).forEach(o=>{(t===j||t===o)&&Object.keys(i[o]).forEach(p=>d.test(p)&&i[o][p].push([e,n]))});return}const r=ta(a)||[a];for(let d=0,o=r.length;d<o;d++){const p=r[d];Object.keys(i).forEach(f=>{var m;(t===j||t===f)&&((m=i[f])[p]||(m[p]=[...at(s[f],p)||at(s[j],p)||[]]),i[f][p].push([e,n-o+d+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(l(this,z)).concat(Object.keys(l(this,U))).forEach(a=>{t[a]||(t[a]=g(this,Pt,fa).call(this,a))}),u(this,U,u(this,z,void 0)),Ga(),t}},U=new WeakMap,z=new WeakMap,Pt=new WeakSet,fa=function(t){const a=[];let e=t===j;return[l(this,U),l(this,z)].forEach(s=>{const i=s[t]?Object.keys(s[t]).map(n=>[n,s[t][n]]):[];i.length!==0?(e||(e=!0),a.push(...i)):t!==j&&a.push(...Object.keys(s[j]).map(n=>[n,s[j][n]]))}),e?Ka(a):null},Kt),J,D,Yt,Qa=(Yt=class{constructor(t){h(this,"name","SmartRouter");x(this,J,[]);x(this,D,[]);u(this,J,t.routers)}add(t,a,e){if(!l(this,D))throw new Error(la);l(this,D).push([t,a,e])}match(t,a){if(!l(this,D))throw new Error("Fatal error");const e=l(this,J),s=l(this,D),i=e.length;let n=0,r;for(;n<i;n++){const c=e[n];try{for(let d=0,o=s.length;d<o;d++)c.add(...s[d]);r=c.match(t,a)}catch(d){if(d instanceof oa)continue;throw d}this.match=c.match.bind(c),u(this,J,[c]),u(this,D,void 0);break}if(n===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(l(this,D)||l(this,J).length!==1)throw new Error("No active router has been determined yet.");return l(this,J)[0]}},J=new WeakMap,D=new WeakMap,Yt),ut=Object.create(null),q,E,X,ct,R,N,G,pt,Xa=(pt=class{constructor(a,e,s){x(this,N);x(this,q);x(this,E);x(this,X);x(this,ct,0);x(this,R,ut);if(u(this,E,s||Object.create(null)),u(this,q,[]),a&&e){const i=Object.create(null);i[a]={handler:e,possibleKeys:[],score:0},u(this,q,[i])}u(this,X,[])}insert(a,e,s){u(this,ct,++_t(this,ct)._);let i=this;const n=Ta(e),r=[];for(let c=0,d=n.length;c<d;c++){const o=n[c],p=n[c+1],f=Oa(o,p),m=Array.isArray(f)?f[0]:o;if(m in l(i,E)){i=l(i,E)[m],f&&r.push(f[1]);continue}l(i,E)[m]=new pt,f&&(l(i,X).push(f),r.push(f[1])),i=l(i,E)[m]}return l(i,q).push({[a]:{handler:s,possibleKeys:r.filter((c,d,o)=>o.indexOf(c)===d),score:l(this,ct)}}),i}search(a,e){var d;const s=[];u(this,R,ut);let n=[this];const r=Xt(e),c=[];for(let o=0,p=r.length;o<p;o++){const f=r[o],m=o===p-1,b=[];for(let y=0,P=n.length;y<P;y++){const v=n[y],S=l(v,E)[f];S&&(u(S,R,l(v,R)),m?(l(S,E)["*"]&&s.push(...g(this,N,G).call(this,l(S,E)["*"],a,l(v,R))),s.push(...g(this,N,G).call(this,S,a,l(v,R)))):b.push(S));for(let B=0,St=l(v,X).length;B<St;B++){const Rt=l(v,X)[B],I=l(v,R)===ut?{}:{...l(v,R)};if(Rt==="*"){const _=l(v,E)["*"];_&&(s.push(...g(this,N,G).call(this,_,a,l(v,R))),u(_,R,I),b.push(_));continue}const[xa,Vt,ft]=Rt;if(!f&&!(ft instanceof RegExp))continue;const L=l(v,E)[xa],ga=r.slice(o).join("/");if(ft instanceof RegExp){const _=ft.exec(ga);if(_){if(I[Vt]=_[0],s.push(...g(this,N,G).call(this,L,a,l(v,R),I)),Object.keys(l(L,E)).length){u(L,R,I);const It=((d=_[0].match(/\//))==null?void 0:d.length)??0;(c[It]||(c[It]=[])).push(L)}continue}}(ft===!0||ft.test(f))&&(I[Vt]=f,m?(s.push(...g(this,N,G).call(this,L,a,I,l(v,R))),l(L,E)["*"]&&s.push(...g(this,N,G).call(this,l(L,E)["*"],a,I,l(v,R)))):(u(L,R,I),b.push(L)))}}n=b.concat(c.shift()??[])}return s.length>1&&s.sort((o,p)=>o.score-p.score),[s.map(({handler:o,params:p})=>[o,p])]}},q=new WeakMap,E=new WeakMap,X=new WeakMap,ct=new WeakMap,R=new WeakMap,N=new WeakSet,G=function(a,e,s,i){const n=[];for(let r=0,c=l(a,q).length;r<c;r++){const d=l(a,q)[r],o=d[e]||d[j],p={};if(o!==void 0&&(o.params=Object.create(null),n.push(o),s!==ut||i&&i!==ut))for(let f=0,m=o.possibleKeys.length;f<m;f++){const b=o.possibleKeys[f],y=p[o.score];o.params[b]=i!=null&&i[b]&&!y?i[b]:s[b]??(i==null?void 0:i[b]),p[o.score]=!0}}return n},pt),Z,Qt,Za=(Qt=class{constructor(){h(this,"name","TrieRouter");x(this,Z);u(this,Z,new Xa)}add(t,a,e){const s=ta(a);if(s){for(let i=0,n=s.length;i<n;i++)l(this,Z).insert(t,s[i],e);return}l(this,Z).insert(t,a,e)}match(t,a){return l(this,Z).search(t,a)}},Z=new WeakMap,Qt),ua=class extends Ha{constructor(t={}){super(t),this.router=t.router??new Qa({routers:[new Ya,new Za]})}},te=t=>{const e={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...t},s=(n=>typeof n=="string"?n==="*"?()=>n:r=>n===r?r:null:typeof n=="function"?n:r=>n.includes(r)?r:null)(e.origin),i=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(e.allowMethods);return async function(r,c){var p;function d(f,m){r.res.headers.set(f,m)}const o=await s(r.req.header("origin")||"",r);if(o&&d("Access-Control-Allow-Origin",o),e.credentials&&d("Access-Control-Allow-Credentials","true"),(p=e.exposeHeaders)!=null&&p.length&&d("Access-Control-Expose-Headers",e.exposeHeaders.join(",")),r.req.method==="OPTIONS"){e.origin!=="*"&&d("Vary","Origin"),e.maxAge!=null&&d("Access-Control-Max-Age",e.maxAge.toString());const f=await i(r.req.header("origin")||"",r);f.length&&d("Access-Control-Allow-Methods",f.join(","));let m=e.allowHeaders;if(!(m!=null&&m.length)){const b=r.req.header("Access-Control-Request-Headers");b&&(m=b.split(/\s*,\s*/))}return m!=null&&m.length&&(d("Access-Control-Allow-Headers",m.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await c(),e.origin!=="*"&&r.header("Vary","Origin",{append:!0})}},ae=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,zt=(t,a=se)=>{const e=/\.([a-zA-Z0-9]+?)$/,s=t.match(e);if(!s)return;let i=a[s[1]];return i&&i.startsWith("text")&&(i+="; charset=utf-8"),i},ee={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},se=ee,ie=(...t)=>{let a=t.filter(i=>i!=="").join("/");a=a.replace(new RegExp("(?<=\\/)\\/+","g"),"");const e=a.split("/"),s=[];for(const i of e)i===".."&&s.length>0&&s.at(-1)!==".."?s.pop():i!=="."&&s.push(i);return s.join("/")||"."},ha={br:".br",zstd:".zst",gzip:".gz"},ne=Object.keys(ha),re="index.html",le=t=>{const a=t.root??"./",e=t.path,s=t.join??ie;return async(i,n)=>{var p,f,m,b;if(i.finalized)return n();let r;if(t.path)r=t.path;else try{if(r=decodeURIComponent(i.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(r))throw new Error}catch{return await((p=t.onNotFound)==null?void 0:p.call(t,i.req.path,i)),n()}let c=s(a,!e&&t.rewriteRequestPath?t.rewriteRequestPath(r):r);t.isDir&&await t.isDir(c)&&(c=s(c,re));const d=t.getContent;let o=await d(c,i);if(o instanceof Response)return i.newResponse(o.body,o);if(o){const y=t.mimes&&zt(c,t.mimes)||zt(c);if(i.header("Content-Type",y||"application/octet-stream"),t.precompressed&&(!y||ae.test(y))){const P=new Set((f=i.req.header("Accept-Encoding"))==null?void 0:f.split(",").map(v=>v.trim()));for(const v of ne){if(!P.has(v))continue;const S=await d(c+ha[v],i);if(S){o=S,i.header("Content-Encoding",v),i.header("Vary","Accept-Encoding",{append:!0});break}}}return await((m=t.onFound)==null?void 0:m.call(t,c,i)),i.body(o)}await((b=t.onNotFound)==null?void 0:b.call(t,c,i)),await n()}},oe=async(t,a)=>{let e;a&&a.manifest?typeof a.manifest=="string"?e=JSON.parse(a.manifest):e=a.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?e=JSON.parse(__STATIC_CONTENT_MANIFEST):e=__STATIC_CONTENT_MANIFEST;let s;a&&a.namespace?s=a.namespace:s=__STATIC_CONTENT;const i=e[t]||t;if(!i)return null;const n=await s.get(i,{type:"stream"});return n||null},de=t=>async function(e,s){return le({...t,getContent:async n=>oe(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:e.env?e.env.__STATIC_CONTENT:void 0})})(e,s)},ce=t=>de(t);const wt=new ua;wt.use("/api/*",te());wt.use("/static/*",ce({root:"./public"}));wt.post("/api/contact",async t=>{var a;try{const e=await t.req.json(),{name:s,email:i,organization:n,phone:r,message:c,type:d,language:o}=e;if(!s||!i||!c)return t.json({success:!1,error:"Required fields are missing"},400);if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i))return t.json({success:!1,error:"Invalid email format"},400);console.log("Contact form submission:",{name:s,email:i,organization:n,phone:r,message:c,type:d,language:o});const f=o==="ja"?`【VALORISE】新規お問い合わせ - ${s}様`:`[VALORISE] New Inquiry - ${s}`,m=`
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
